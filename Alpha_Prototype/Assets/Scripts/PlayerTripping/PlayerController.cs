...
public class PlayerController : MonoBehaviour
{
    ...
    IEnumerator TraversePath()
    {
        ...
        // Vector3 behindEngine = initialPosition - Engine.forward * carriageOffset;
            Vector3 behindEngine = Engine.position - Engine.forward * carriageOffset;
        ...
        while (true)
        {
            ...
            if (Vector3.Distance(Engine.position, targetPoint) < 0.1f)
            {
                ...
                Carriage.position = Vector3.MoveTowards(Carriage.position, Engine.position + new Vector3(4.0f, 2.0f, 0f), movementSpeed * Time.deltaTime);
            ...
            // float offset = 2.0f;
            // Vector3 offsetTargetPoint = targetPoint + Engine.position - Carriage.position;
            ...
            Carriage.position = Vector3.MoveTowards(Carriage.position, targetPoint -  new Vector3(1.0f,0f,0f), movementSpeed * Time.deltaTime);
            // Carriage.position = Vector3.MoveTowards(Carriage.position, lastPosition - new Vector3(1.0f,0f,0f), movementSpeed * Time.deltaTime);
...
IEnumerator FollowEngine()
{
    ...
    while (isEngineMoving || pathPositions.Count > 0)
    {
        ...
        else
        {
                ...
                // float offset = 2.0f;
                // Vector3 offsetTargetPoint = lastPosition + Carriage.position;
            Carriage.position = Vector3.MoveTowards(Carriage.position, lastPosition - new Vector3(1.0f,0f,0f), movementSpeed * Time.deltaTime);
    ...
    Carriage.position = Vector3.MoveTowards(Carriage.position, lastPosition + new Vector3(4.0f, 0f, 0f), movementSpeed * Time.deltaTime);
